...
const pageApi = {
  optionBuy: { url:"/newapi/promotion/optionBuy/item", method:"get"},
	rule: { url:"/newapi/promotion/rule" , method:"get" },
	shop: { url: "/newapi/promotion/optionBuy/cart", method:"get" },
...
class OptionBuyActivity extends Component{
	constructor( props, context ){
		super( props );
		document.title = "N元任选";
		if( context.isApp ) location.href = "jsbridge://set_title?title=N元任选";
	...
	dropDown =( me )=>{
		...
		axios.request({ ...pageApi.optionBuy,
			params:{
...
class PageHead extends Component{
	parseRule(){
		...
		return rules.option_amount +"元任选" + rules.option_quantity + "件";
	}
	render(){
...
function optionBuyActivityState ( state ) {
	return {
    ...state.minusActivity,
    // ...state.global
	}
...
function optionBuyActivityDispatch ( dispatch, props ) {
...
export default connect( optionBuyActivityState, optionBuyActivityDispatch )( OptionBuyActivity );
